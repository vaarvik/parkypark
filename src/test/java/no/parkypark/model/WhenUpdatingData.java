...
public class WhenUpdatingData {
    private static Stream<Arguments> newParkinglotsData(){
        ...
        parkinglots.add(new Parkinglot("Peter", "Lumberg Street"));
    ...
    @ParameterizedTest()
    @MethodSource("newParkinglotsData")
    public void dataIsUpdated(List<Parkinglot> expectedLots, String filePath) {

        ParkyparkRepository repo = new ParkyparkRepository(filePath);
        repo = repo.addParkinglot(new Parkinglot("Peter", "Lumberg Street"));
